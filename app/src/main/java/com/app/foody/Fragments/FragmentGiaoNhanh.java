...
public class FragmentGiaoNhanh extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.giaonhanh_giaonhanh,container,false);
        listViewGanToi = (ListView)mRootView.findViewById(R.id.lvGiaoNhanh);
