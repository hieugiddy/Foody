...
public class FragmentGanToi_GiaoNhanh extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.giaonhanh_gantoi,container,false);
        listViewGanToi = (ListView)mRootView.findViewById(R.id.lvGanToi);
